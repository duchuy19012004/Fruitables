...
public class RbacService : IRbacService
{
        ...
        string? newValue = null)
    {
        ...
        await _db.RbacAuditLogs.AddAsync(auditLog);
    }
    ...
    public async Task<List<string>> GetUserPermissionsAsync(int userId)
    {
        ...
        var userRoles = await _db.UserRoleMappings
    ...
    public async Task DeleteRoleAsync(int roleId, int adminId)
    {
        ...
        var hasUsers = await _db.UserRoleMappings
    ...
    public async Task DeletePermissionAsync(int permissionId, int adminId)
    {
        ...
        var hasRoles = await _db.RolePermissions
    ...
    public async Task AssignRolesToUserAsync(int userId, List<int> roleIds, int adminId)
    {
        ...
        var existingMappings = await _db.UserRoleMappings
            .Include(ur => ur.Role)
        ...
        var supportsTransactions = !(_db.Database.ProviderName?.Contains("InMemory") ?? false);
        ...
        try
        {
            ...
            if (toAddIds.Any())
            {
                foreach (var roleId in toAddIds)
                {
                    ...
                    await _db.UserRoleMappings.AddAsync(userRole);
            ...
            // its internal SaveChangesAsync participates in the same DbContext transaction.
    ...
    {
        var userRole = await _db.UserRoleMappings
        ...
        _db.UserRoleMappings.Remove(userRole);
        await _db.SaveChangesAsync();
    ...
    public async Task InvalidateRoleCacheAsync(int roleId)
    {
        ...
        var userIds = await _db.UserRoleMappings
    ...
    {
        IQueryable<RbacAuditLog> query = _db.RbacAuditLogs
