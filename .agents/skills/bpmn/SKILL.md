---
name: bpmn
description: Dùng khi cần BPMN 2.0 chuẩn OMG cho quy trình nghiệp vụ đa vai trò. Trong Codex, gọi bằng `$bpmn` kèm mô tả và feature slug.
---

## Codex project adapter

- Gọi rõ bằng `$bpmn`.
- Engine nằm tại `.agents/skills/bpmn/engine` và dependency được cài cục bộ bởi `.agents/scripts/setup-tools.ps1`.
- Chạy engine bằng Node theo các lệnh `.agents/skills/bpmn/engine/*.mjs` trong tài liệu.
