---
name: sequence
description: Dùng khi cần sequence diagram Mermaid cho login, checkout, webhook hoặc error recovery. Trong Codex, gọi bằng `$sequence` kèm mô tả và feature slug.
---

## Codex project adapter

- Gọi rõ bằng `$sequence`.
