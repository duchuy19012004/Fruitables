...
namespace Fruitables.Migrations
{
    ...
    [Migration("20260801154819_AddFreshProduceReturnWorkflow")]
    partial class AddFreshProduceReturnWorkflow
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Fruitables.Models.Returns.InventoryDisposition", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("ReturnRequestItemId", "CreatedAtUtc");

                    b.ToTable("InventoryDispositions", t =>
                        {
                            t.HasCheckConstraint("CK_InventoryDispositions_Quantity", "[Quantity] > 0");
                        });
                });
            ...
            modelBuilder.Entity("Fruitables.Models.Returns.Refund", b =>
                {
                    ...
                    b.Property<string>("DestinationAccountHolderProtected")
                        .HasMaxLength(1000)
                        .HasColumnType("nvarchar(1000)");

                    b.Property<string>("DestinationAccountLast4")
                        .HasMaxLength(4)
                        .HasColumnType("nvarchar(4)");

                    b.Property<string>("DestinationAccountNumberProtected")
                        .HasMaxLength(1000)
                        .HasColumnType("nvarchar(1000)");
                    ...
                    b.Property<DateTime?>("DestinationSubmittedAtUtc")
                        .HasColumnType("datetime2");

                    b.Property<int>("FailureAttemptCount")
                        .HasColumnType("int");
                    ...
                    b.Property<decimal>("FinancialSeparationThresholdSnapshot")
                        .HasPrecision(12, 2)
                        .HasColumnType("decimal(12,2)");
                    ...
                    b.Property<string>("TransferEvidenceStorageKey")
                        .HasMaxLength(128)
                        .HasColumnType("nvarchar(128)");
            ...
            modelBuilder.Entity("Fruitables.Models.Returns.ReturnAccountSupportRestriction", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("UserId", "EffectiveFromUtc", "ExpiresAtUtc");

                    b.ToTable("ReturnAccountSupportRestrictions");
                });

            modelBuilder.Entity("Fruitables.Models.Returns.ReturnApprovalRule", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<bool>("RequiresDifferentActor")
                        .HasColumnType("bit");
                    ...
                    b.HasIndex("RoleName", "Action", "Version")
                        .IsUnique();

                    b.ToTable("ReturnApprovalRules");
                });

            modelBuilder.Entity("Fruitables.Models.Returns.ReturnDecisionProposal", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<bool>("ShippingFeeEligibilitySnapshot")
                        .HasColumnType("bit");
                    ...
                    b.HasIndex("ReturnRequestId", "Version")
                        .IsUnique();

                    b.ToTable("ReturnDecisionProposals");
                });

            modelBuilder.Entity("Fruitables.Models.Returns.ReturnDecisionProposalItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("ApprovedDamagePercentage")
                        .HasColumnType("int");
                    ...
                    b.Property<int>("ReturnDecisionProposalId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("ReturnDecisionProposalId", "ReturnRequestItemId")
                        .IsUnique();

                    b.ToTable("ReturnDecisionProposalItems", t =>
                        {
                            t.HasCheckConstraint("CK_ReturnDecisionProposalItems_ApprovedQuantity", "[ApprovedQuantity] >= 0");
                        });
                });
            ...
            modelBuilder.Entity("Fruitables.Models.Returns.ReturnEvent", b =>
                {
                    ...
                    b.HasIndex("ReturnDecisionProposalId");
            ...
            modelBuilder.Entity("Fruitables.Models.Returns.ReturnEvidenceLink", b =>
                {
                    b.Property<int>("ReturnEvidenceId")
                        .HasColumnType("int");

                    b.Property<int>("ReturnRequestItemId")
                        .HasColumnType("int");

                    b.HasKey("ReturnEvidenceId", "ReturnRequestItemId");

                    b.HasIndex("ReturnRequestItemId");

                    b.ToTable("ReturnEvidenceLinks");
                });

            modelBuilder.Entity("Fruitables.Models.Returns.ReturnPolicy", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<bool>("AllowRestock")
                        .HasColumnType("bit");

                    b.Property<bool>("AllowStoreCredit")
                        .HasColumnType("bit");

                    b.Property<int>("AllowedDamagePercentages")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasDefaultValue(15);

                    b.Property<int>("AppealWindowHours")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasDefaultValue(24);

                    b.Property<decimal>("AutoApprovalAmountCap")
                        .ValueGeneratedOnAdd()
                        .HasPrecision(12, 2)
                        .HasColumnType("decimal(12,2)")
                    ...
                    b.Property<decimal>("AutoApprovalOrderRatioCap")
                        .ValueGeneratedOnAdd()
                        .HasPrecision(5, 2)
                    ...
                    b.Property<int>("ClaimWindowHours")
                        .HasColumnType("int");
                    ...
                    b.Property<decimal>("PostReviewSampleRate")
                        .ValueGeneratedOnAdd()
                        .HasPrecision(5, 2)
                        .HasColumnType("decimal(5,2)")
                        .HasDefaultValue(10m);
                    ...
                    b.Property<int>("SupplementWindowHours")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasDefaultValue(24);
                    ...
                    b.HasIndex("Version", "EffectiveFromUtc");

                    b.HasIndex("Scope", "ProductId", "CategoryId", "Reason", "IsActive");

                    b.ToTable("ReturnPolicies", t =>
                        {
                            t.HasCheckConstraint("CK_ReturnPolicies_AutoApprovalRatio", "[AutoApprovalOrderRatioCap] >= 0 AND [AutoApprovalOrderRatioCap] <= 100");
                        });
                });
            ...
            modelBuilder.Entity("Fruitables.Models.Returns.ReturnRequest", b =>
                {
                    ...
                    b.Property<int>("DecisionPackageVersion")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasDefaultValue(0);

                    b.Property<DateTime?>("DecisionProposedAtUtc")
                        .HasColumnType("datetime2");
                    ...
                    b.Property<DateTime?>("EvidenceDueAtUtc")
                        .HasColumnType("datetime2");
                    ...
                    b.Property<DateTime?>("ManagerApprovalDueAtUtc")
                        .HasColumnType("datetime2");

                    b.Property<bool>("MerchantFault")
                        .HasColumnType("bit");
                    ...
                    b.Property<int>("ReviewSlaHoursSnapshot")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasDefaultValue(24);
                    ...
                    b.Property<bool>("ShippingFeeApproved")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("Fruitables.Models.Returns.ReturnRequestItem", b =>
                {
                    ...
                    b.Property<DateTime?>("AppealDeadlineAtUtc")
                        .HasColumnType("datetime2");
                    ...
                    b.Property<DateTime>("ClaimDeadlineAtUtcSnapshot")
                        .HasColumnType("datetime2");

                    b.Property<int>("ClaimWindowHoursSnapshot")
                        .HasColumnType("int");
                    ...
                    b.Property<int?>("CurrentDecisionProposalId")
                        .HasColumnType("int");

                    b.Property<int>("DamagePercentageApproved")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasDefaultValue(0);

                    b.Property<int>("DamagePercentageRequested")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasDefaultValue(100);
                    ...
                    b.Property<bool>("EvidenceRequiredSnapshot")
                        .HasColumnType("bit");

                    b.Property<decimal>("NetPaidAmountSnapshot")
                        .HasPrecision(12, 2)
                        .HasColumnType("decimal(12,2)");
            ...
            modelBuilder.Entity("Fruitables.Models.Returns.InventoryDisposition", b =>
                {
                    b.HasOne("Fruitables.Models.User", "InspectorUser")
                        .WithMany()
            ...
            modelBuilder.Entity("Fruitables.Models.Returns.ReturnAccountSupportRestriction", b =>
                {
                    b.HasOne("Fruitables.Models.User", "ApprovedByUser")
                        .WithMany()
            ...
            modelBuilder.Entity("Fruitables.Models.Returns.ReturnDecisionProposal", b =>
                {
                    ...
                    b.HasOne("Fruitables.Models.User", "ProposedByUser")
                        .WithMany()
            ...
            modelBuilder.Entity("Fruitables.Models.Returns.ReturnDecisionProposalItem", b =>
                {
                    b.HasOne("Fruitables.Models.Returns.ReturnDecisionProposal", "Proposal")
                        .WithMany("Items")
                        .HasForeignKey("ReturnDecisionProposalId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("Fruitables.Models.Returns.ReturnEvent", b =>
                {
                    ...
                    b.HasOne("Fruitables.Models.Returns.ReturnDecisionProposal", "ReturnDecisionProposal")
                        .WithMany()
                        .HasForeignKey("ReturnDecisionProposalId")
                        .OnDelete(DeleteBehavior.Restrict);
                    ...
                    b.Navigation("ReturnDecisionProposal");
            ...
            modelBuilder.Entity("Fruitables.Models.Returns.ReturnEvidenceLink", b =>
                {
                    b.HasOne("Fruitables.Models.Returns.ReturnEvidence", "Evidence")
                        .WithMany("ItemLinks")
                        .HasForeignKey("ReturnEvidenceId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("Fruitables.Models.Returns.ReturnRequest", b =>
                {
                    b.HasOne("Fruitables.Models.User", "AssignedReviewer")
                        .WithMany()
                    ...
                    b.HasOne("Fruitables.Models.User", "Reviewer")
                        .WithMany()
            ...
            modelBuilder.Entity("Fruitables.Models.Returns.ReturnRequestItem", b =>
                {
                    ...
                    b.HasOne("Fruitables.Models.Returns.ReturnPolicy", "ReturnPolicy")
                        .WithMany()
            ...
            modelBuilder.Entity("Fruitables.Models.Returns.ReturnRequest", b =>
                {
                    b.Navigation("DecisionProposals");
