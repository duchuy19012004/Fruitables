...
public class OpenAiClientParsingTests
{
    [Fact]
    public void ParseChatCompletionContent_extracts_message_content()
    {
        ...
        var content = OpenAiResponseParser.ParseChatCompletionContent(json);
    ...
    public void ParseChatCompletionContent_throws_on_unexpected_payload(string json)
    {
        var ex = Assert.Throws<InvalidOperationException>(
            () => OpenAiResponseParser.ParseChatCompletionContent(json));
    ...
    public void TryParseStreamDeltaContent_extracts_delta_text()
    {
        ...
        var delta = OpenAiResponseParser.TryParseStreamDeltaContent(json);
    ...
    {
        Assert.Null(OpenAiResponseParser.TryParseStreamDeltaContent(json));
    }
    ...
    public void ParseEmbedding_extracts_float_array()
    {
        ...
        var vector = OpenAiResponseParser.ParseEmbedding(json);
    ...
    {
        var ex = Assert.Throws<InvalidOperationException>(
            () => OpenAiResponseParser.ParseEmbedding(json));
